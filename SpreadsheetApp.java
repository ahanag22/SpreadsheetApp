...
public class SpreadsheetApp {
    ...
    private static void menuPrintCellFormula(Spreadsheet theSpreadsheet) {
        ...
        Util.getCellToken(inputString, 0, cellToken);
    
        System.out.println(Util.printCellToken(cellToken));
        System.out.println(": ");
    
        if ((cellToken.getRow() < 0) ||
            (cellToken.getRow() >= theSpreadsheet.getNumRows()) ||
            (cellToken.getColumn() < 0) ||
            (cellToken.getColumn() >= theSpreadsheet.getNumRows())) {
    ...
    private static void menuChangeCellFormula(Spreadsheet theSpreadsheet) {
        ...
        //edit: the getCellToken returns a CellToken type and is stored to cellToken
        cellToken = theSpreadsheet.getCellToken (inputCell, 0, cellToken);
        ...
        expTreeTokenStack = Util.getFormula(inputFormula);
    ...
    public static void main(String[] args) {
        ...
        Spreadsheet theSpreadsheet = new Spreadsheet(r, c);
